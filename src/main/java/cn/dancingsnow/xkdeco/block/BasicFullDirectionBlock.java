...
public final class BasicFullDirectionBlock extends Block implements Waterloggable, XKDecoBlock.Basic {
    ...
    public BasicFullDirectionBlock(Settings settings, Map<Direction, ? extends VoxelShape> shapes) {
        super(settings);
